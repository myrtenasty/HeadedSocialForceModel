...
% X decomposition
% [By SSK] X is to store the position and velocity of each pedestian.
% [By SSK] The position and velocity of pedstrians are recorded as
% [By SSK] 6-dimention numbers.
